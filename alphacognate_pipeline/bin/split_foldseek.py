...
def main():
    ...
    print(foldseek_combined.columns)
    print(structure_manifest)
    foldseek_combined = foldseek_combined.merge(structure_manifest, left_on = "query", right_on = "accession", how = "inner")
